...
# Main folder with pH subfolders
...
# Output CSV file
output_csv = "/content/drive/MyDrive/MD/JAM_pH/JAMC/rmsf_per_residue.csv"
...
for ph_folder in ph_folders_sorted:
    ...
    for xtc_file in xtc_files_sorted:
        ...
        print(f"Processing: {ph_folder} - {xtc_file}")
        ...
        # Automatically select "Protein" group (index 1 usually)
        ...
        for i, value in enumerate(res, start=1):
            all_results.append({
                "pH": ph_folder,
                "xtc_file": xtc_file,
                "residue": i,
...
print(f"Saved RMSF results to {output_csv}")
